...
result = RF('../Experiment 2 - Prediction of the number of newborns deaths from pneumonia/DATABASE_EXPERIMENT_2.csv', 'NDN', random)
result.to_csv('../Results/RF_RESULTS_EXPERIMENT2.csv' , sep=';',  encoding='utf-8')
print("==============================================================================================================================================================")
print("The complete result will be saved in the folder: Results, with name: RF_RESULTS_EXPERIMENT2.csv")
