...
result = ANN('../Experiment 2 - Prediction of the number of newborns deaths from pneumonia/DATABASE_EXPERIMENT_2.csv', 'NDN', random)
result.to_csv('../Results/ANN_RESULTS_EXPERIMENT2.csv' , sep=';',  encoding='utf-8')
print("==============================================================================================================================================================")
print("The complete result will be saved in the folder: Results, with name: ANN_RESULTS_EXPERIMENT2.csv")
